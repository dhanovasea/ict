...
>
  <head>
    ...
    <title>Portal IT - Sekolah Global Mandiri</title>
...
<?php 
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.php" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Portal IT</span>
                </a>
              </div>
              <!-- /Logo -->
	...
	function validasi() {
		...
		if (username != "Enter your email or username" && password!="············") {
			return true;
		}else{
