...
$result = mysqli_query($koneksi, 'SELECT * FROM IPC where Status="Aktif"');
...
?>
	     ...
	     <div class="card">
			...
			if ($user_data['Status'] == NULL) { 
				...
				<a class='dropdown-item' href='ip.php?d=E$user_data[IP]'><i class='bx bx-edit-alt me-1'></i> Edit</a> "; ?>

			<!--
			<a href="ip.php?d=<?php echo $user_data['IP']; ?>"
			<button
                          type="button"
                          ...
                          <div class="modal-dialog">
                            <form class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="backDropModalTitle">Edit Data IP Address <?php //echo $_GET["d"];?></h5>
                                <button
                                  type="button"
                                  class="btn-close"
