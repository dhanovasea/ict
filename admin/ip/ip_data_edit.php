...
?>
	...
	<div class="container-xxl flex-grow-1 container-p-y">
	      ...
	      <div class="col-md-12">
                  <div class="card mb-8">                    
                    <div class="card-body"> 
					<form name="update_ip" method="post" action="ip/ip_data_edit_simpan.php">
					  ...
					  <div class="form-floating">                        
						<select class="form-select" id="type" name="type" aria-label="Default select example">
                          ...
                          <option selected value="1">Server</option>
                          <option value="2">Client</option>
						  <option value="3">AP (Wifi)</option>
						  <option value="4">DVR/NVR</option>
                          ...
                          <option value="1">Server</option>
                          <option value="2">Client</option>
						  <option selected value="3">AP (Wifi)</option>
						  <option value="4">DVR/NVR</option>
						  <option value="5">Printer</option>
						  <option value="6">Lain-lain</option>
                          ...
                          <option value="2">Client</option>
						  <option value="3">AP (Wifi)</option>
						  <option selected value="4">DVR/NVR</option>
						  <option value="5">Printer</option>
						  <option value="6">Lain-lain</option>
						  ...
						  <option value="3">AP (Wifi)</option>
						  <option value="4">DVR/NVR</option>
						  <option selected value="5">Printer</option>
						  <option value="6">Lain-lain</option>
						  ...
						  <option value="4">DVR/NVR</option>
						  <option value="5">Printer</option>
						  <option selected value="6">Lain-lain</option>
						  <?php } else { ?>"
