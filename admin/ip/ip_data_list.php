...
//if ($_GET['k'] == 'cibubur') { $result = mysqli_query($koneksi, 'SELECT * FROM IPC');}
if (($_GET['k'] == 'cibubur') AND (($_SESSION['hak_akses'] == "cibubur") OR ($_SESSION['hak_akses'] == "admin"))) 
	{ $result = mysqli_query($koneksi, 'SELECT * FROM IPC');}
	     ...
	     <div class="card" >
		    ...
		    $no=1;  
    		    while($user_data = mysqli_fetch_array($result)) {  
					  ...
					  if ($_GET['k'] == 'cibubur') 
						{ 
							echo "<td><a class='dropdown-item' href='ip.php?d=E$user_data[IP]'>".$user_data['IP']."</a></td>"; }
					  else if ($_GET['k'] == 'jakarta') 
						{ echo "<td><a class='dropdown-item' href='ip.php?d=F$user_data[IP]'>".$user_data['IP']."</a></td>"; }
						...
						if ($user_data['Type'] == NULL) { echo "<td>Null</td>"; }
						else if ($user_data['Type'] == "0") { echo "<td>Null</td>"; }
						else if ($user_data['Type'] == "1") { echo "<td>Server</td>"; }
						else if ($user_data['Type'] == "2") { echo "<td>Client</td>"; }
						else if ($user_data['Type'] == "3") { echo "<td>AP (Wifi)</td>"; }
						else if ($user_data['Type'] == "4") { echo "<td>DVR/NVR</td>"; }
						else if ($user_data['Type'] == "5") { echo "<td>Printer</td>"; }
						else if ($user_data['Type'] == "6") { echo "<td>Lain-lain</td>"; }
                      	else { echo "<td>".$user_data['Type']."</td>"; }
				...
				if ($_GET['k'] == 'cibubur') 
					{ echo "<a class='dropdown-item' href='ip.php?d=E$user_data[IP]'><i class='bx bx-edit-alt me-1'></i> Edit</a> "; }
				else if ($_GET['k'] == 'jakarta') { echo "<a class='dropdown-item' href='ip.php?d=F$user_data[IP]'><i class='bx bx-edit-alt me-1'></i> Edit</a> "; }
