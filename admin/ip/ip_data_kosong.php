...
if (($_GET['k'] == 'cibubur') AND (($_SESSION['hak_akses'] == "cibubur") OR ($_SESSION['hak_akses'] == "admin"))) 
	{ $result = mysqli_query($koneksi, 'SELECT * FROM IPC where Status is NULL and Mac is NULL');}

else if (($_GET['k'] == 'jakarta') AND (($_SESSION['hak_akses'] == "jakarta") OR ($_SESSION['hak_akses'] == "admin"))) 
	{ $result = mysqli_query($koneksi, 'SELECT * FROM IPJ where Status is NULL and Mac is NULL');}
