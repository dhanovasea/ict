...
if (($_GET['k'] == 'cibubur') AND (($_SESSION['hak_akses'] == "cibubur") OR ($_SESSION['hak_akses'] == "admin"))) 
	{ $result = mysqli_query($koneksi, 'SELECT * FROM IPC_CCTV');}

else if (($_GET['k'] == 'jakarta') AND (($_SESSION['hak_akses'] == "jakarta") OR ($_SESSION['hak_akses'] == "admin"))) 
	{ $result = mysqli_query($koneksi, 'SELECT * FROM IPJ_CCTV');}
...
?>
	     ...
	     <div class="card" >
				...
				if ($_GET['k'] == 'cibubur') 
					...
					<?php } else if ($_GET['k'] == 'jakarta') {?> <h5 class="card-header">Data IP Address 192.168.200.0/24 (Jakarta)</h5><?php  }
				?>
		    ...
		    $no=1;  
    		    while($user_data = mysqli_fetch_array($result)) {  
					  ...
					  if ($_GET['k'] == 'cibubur') 
						{ 
							echo "<td><a class='dropdown-item' href='cctv.php?d=E$user_data[IP]'>".$user_data['IP']."</a></td>"; }
					  else if ($_GET['k'] == 'jakarta') 
						{ echo "<td><a class='dropdown-item' href='cctv.php?d=F$user_data[IP]'>".$user_data['IP']."</a></td>"; }
						...
						else if ($user_data['Type'] == "1") { echo "<td>DVR/NVR</td>"; }
						else if ($user_data['Type'] == "2") { echo "<td>Kamera CCTV</td>"; }
						else if ($user_data['Type'] == "3") { echo "<td>Lain-Lain</td>"; }
